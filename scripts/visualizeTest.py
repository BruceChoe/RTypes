...
#Read similarity matrix generated by SNFtool into dataframes
...
#Read group cluster info into dataframe
...
#PCA time: generate covar matrix and eigen values/vectors.
